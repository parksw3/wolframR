...
%\VignetteDepends{wolframR}
%\VignetteDepends{ggplot2}
%\VignetteDepends{plyr}
%\VignetteDepends{dplyr}
%\VignetteIndexEntry{Collatz sequence}
\documentclass{article}
\title{Visualizing the Collatz sequence}
...
Based on \href{https://www.reddit.com/r/math/comments/38cg9r/a_beautiful_picture_related_to_collatz_conjecture/}{a reddit post}:
...
We can make things slightly fancier:
